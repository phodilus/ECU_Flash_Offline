...
/**	* @brief	Allows to read one block from a specified address in a card.
	...
	* @retval SD_Error: SD Card Error code.
	*/
SD_Error SD_ReadBlock(uint32_t addr, uint8_t *readbuff, uint16_t BlockSize)
{
	SD_Error errorstatus = SD_OK;
...
/**	* @brief	Allows to read blocks from a specified address	in a card.
	...
	* @retval SD_Error: SD Card Error code.
	*/
SD_Error SD_ReadMultiBlocks(uint32_t addr, uint8_t *readbuff, uint16_t BlockSize, uint32_t NumberOfBlocks)
{
	SD_Error errorstatus = SD_OK;
	uint32_t count = 0, *tempbuff = (uint32_t*)readbuff;
	uint8_t power = 0;
...
/**	* @brief	Allows to write one block starting from a specified address 
	...
	* @retval SD_Error: SD Card Error code.
	*/
SD_Error SD_WriteBlock(uint32_t addr, uint8_t *writebuff, uint16_t BlockSize)
{
	SD_Error errorstatus = SD_OK;
...
/**	* @brief	Allows to write blocks starting from a specified address in 
	...
	* @retval SD_Error: SD Card Error code.
	*/
SD_Error SD_WriteMultiBlocks(uint32_t addr, uint8_t *writebuff, uint16_t BlockSize, uint32_t NumberOfBlocks)
{
	SD_Error errorstatus = SD_OK;
